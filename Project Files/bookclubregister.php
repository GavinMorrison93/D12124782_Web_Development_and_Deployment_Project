...
<title>Gavin's Book Club - Registration Page</title>
</head>
<body>
<div class="container">
<header>
...
<h1><center>Welcome to the</center></h1>
	<h1><center>Registration Page</center></h1>
	  <br><br>
      <center>
<form action="bookclubdb.php" method="post" enctype="multipart/form-data">
<b>Please enter a User Name: <input type="text" name="User_Name" placeholder="Enter User Name">
<br><br>
<b>Please enter a password: <input type="text" name="Password" placeholder="Enter Password">
<br><br>
<b>Select image to upload: <input type="file" name="User_Image">
<br><br>
