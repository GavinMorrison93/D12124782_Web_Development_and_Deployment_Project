...
<div>
<h1>Reference</h1>
<p>Our range of reference titles are full of useful information.</p>
</div>
<form>
<?php
include'db_connector.php';
echo '<table border="1">'."\n";
$select1 = ("SELECT Book_ID, Book_Title, Author FROM book_items Where ISBN_Code BETWEEN 'REF001' AND 'REF005'");
