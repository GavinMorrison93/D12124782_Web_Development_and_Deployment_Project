...
<title>Gavin's Book Club - Hobbies</title>
</head>
<body>
<div class="container">
<header>
...
<div>
<h1>Hobbies</h1>
<p>Thinking of taking up a hobby, check out our books on the subject.</p>
</div>
<form>
<?php
include'db_connector.php';
echo '<table border="1">'."\n";
$select1 = ("SELECT Book_ID, Book_Title, Author FROM book_items Where ISBN_Code BETWEEN 'HOB001' AND 'HOB005'");
