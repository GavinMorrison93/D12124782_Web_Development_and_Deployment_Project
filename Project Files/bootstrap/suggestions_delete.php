...
$param_id = trim($_POST["Suggestion_ID"]);         
if($stmt->execute()){            
...
<div class="alert alert-primary">
 <input type="hidden" name="Suggestion_ID" value="<?php echo trim($_GET["Suggestion_ID"]); ?>"/>
<p>Are you sure you want to delete this suggestion?</p><br>
<p>
<input type="submit" value="Yes" class="btn btn-primary">
<a href="suggestions_index.php" class="btn btn-default">No</a>
</p>
</div>
</form>
</div>
